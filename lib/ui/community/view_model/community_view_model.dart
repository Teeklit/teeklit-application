...
class CommunityViewModel extends ChangeNotifier {
  ...
  /// 게시글 저장하기
  Future<void> addPost(String postTitle, String postContents, String category, List<File> images) async{
    if(isLoading) return;
    isLoading = true;
  ...
  /// 게시글 수정
  Future<void> modifyPost(String postTitle, String postContents, String category, List<ModifyImage> images) async{
    if(isLoading) return;
    isLoading = true;
    ...
    await _repo.modifyPost(post.copyWith(
      postTitle: postTitle,
      postContents: postContents,
      category: category,
